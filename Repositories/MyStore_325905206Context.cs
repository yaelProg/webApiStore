...
public partial class MyStore_325905206Context : DbContext
{
    public MyStore_325905206Context()
    {
    }

    public MyStore_325905206Context(DbContextOptions<MyStore_325905206Context> options)
        : base(options)
    {
    }
